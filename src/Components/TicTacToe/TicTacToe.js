...
const TicTacToe = () => {
  ...
  useEffect(() => {
    ...
    else if(array[4]==='O' && array[3]==='' && array[5]==='') newArray[3]="O";
    else if(array[4]==='O' && array[1]==='' && array[7]==='') newArray[1]="O";
    else if(array[4]==='O' && array[1]==='X' && array[5]==='X' && array[2]==='') newArray[2]="O";
